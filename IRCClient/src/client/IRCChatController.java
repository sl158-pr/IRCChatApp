 ...
 *
 */
public class IRCChatController extends javax.swing.JPanel implements IRCSListener {
    ...
    public IRCChatController(String server, String port, String nickname, String channel, JTabbedPane parentPane, TrayIcon ti, IRCChatWindow main) {
        initComponents();
    ...
    private String getIrcString(String input) {
        ...
        if (i.indexOf("/") == 0) {
            ...
            if (command.equalsIgnoreCase("JOIN") || command.equalsIgnoreCase("J")) {
                output = "PART " + channel + "\r\n" + "JOIN " + args;
                channel = args;
            } else if (command.equalsIgnoreCase("PART") || command.equalsIgnoreCase("P")) {
                output = "PART " + channel;
    ...
    private void parseData(String input) {
        ...
        boolean serverMessage = (i.indexOf("!") == -1 || i.indexOf(" ") < i.indexOf("!"));
        if (serverMessage) {
...
//                writeOutput("- Users on " + channel + ":" + us);
                ...
                try {
                    if(i.indexOf("PING") != -1)
                       writeOutput("* " + i, BLUE);
                        ...
                        writeOutput("* " + i.substring(i.indexOf(":", 1) + 1), BLUE);
                } catch (Exception e) {
                    writeOutput("* " + i, BLUE);
                }
            }
            ...
            String params = i.substring(i.indexOf(action) + action.length() + 1);

            if (action.equalsIgnoreCase("PRIVMSG")) {
                writeOutput("<" + nick + "> " + params.substring(params.indexOf(":") + 1));
                writeNotify("<" + nick + "> " + params.substring(params.indexOf(":") + 1));
                ...
                writeOutput(nick + " has quit IRC (" + params.substring(params.indexOf(":") + 1) + ")", GREEN);
                updateUser();
            } else if (action.equalsIgnoreCase("MODE")) {
                String channel = params.substring(0, params.indexOf(" "));
                params = params.substring(params.indexOf(channel) + channel.length() + 1);
                String mode = params.substring(0, 2);
                params = params.substring(params.indexOf(mode) + mode.length() + 1);
                String user = params;
    ...
    private void writeOutput(String s, SimpleAttributeSet set) {
        try {
            outputPane.getDocument().insertString(outputPane.getDocument().getLength(), s + "\n", set);
            outputPane.setCaretPosition(outputPane.getDocument().getLength() - 1);
        } catch (Exception e) {
    ...
    public void onDisconnect() {
        removeFromParent();
        JOptionPane.showMessageDialog(new JFrame(), "You have been disconnected from " + server, "Disconnect", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 480, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jScrollPane4, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)).addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 566, Short.MAX_VALUE));
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jScrollPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 311, Short.MAX_VALUE).addComponent(jScrollPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 311, Short.MAX_VALUE)).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)));
    }// </editor-fold>                        
